...
const games=[
{id:"mlbb",name:"Mobile Legends: Bang Bang",short:"MLBB",logo:LOGO_BASE+"Mobile_Legends_Logo.webp",cover:"https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&w=1200&q=88",genre:"MOBA",dev:"Moonton",players:"2.4k",rating:"4.9",totalPlayers:"10M",officialUrl:"https://www.mobilelegends.com",online:true,description:"Fast 5v5 MOBA sessions built around heroes, lanes, and team play."},
{id:"hok",name:"Honor of Kings",short:"HOK",logo:LOGO_BASE+"Honor_of_Kings_Wordmark_Logo.png",cover:"https://images.unsplash.com/photo-1593305841991-05c297ba4575?auto=format&fit=crop&w=1200&q=88",genre:"MOBA",dev:"Tencent",players:"3.1k",rating:"4.9",totalPlayers:"10M",officialUrl:"https://www.honorofkings.com",online:true,description:"Competitive 5v5 mobile action with quick team fights and ranked play."},
{id:"minecraft",name:"Minecraft",short:"MC",logo:LOGO_BASE+"Minecraft_Logo-en.svg",cover:LOGO_BASE+"Screenshot_from_the_Minecraft_End.png",genre:"Sandbox",dev:"Mojang",players:"8.8k",rating:"4.9",totalPlayers:"100M",officialUrl:"https://www.minecraft.net",online:true,description:"Build, explore, survive, and create worlds with no single path."},
{id:"apex",name:"Apex Legends",short:"APEX",logo:LOGO_BASE+"Apex_Legends_logo.svg",cover:"https://images.unsplash.com/photo-1552820728-8b83bb6b773f?auto=format&fit=crop&w=1200&q=88",genre:"Battle Royale",dev:"Electronic Arts",players:"5.7k",rating:"4.9",totalPlayers:"50M",officialUrl:"https://www.ea.com/games/apex-legends",online:true,description:"Hero-based battle royale built around movement, squads, and clutch plays."},
{id:"valorant",name:"VALORANT",short:"VAL",logo:LOGO_BASE+"Valorant_logo.svg",cover:"https://images.unsplash.com/photo-1547394765-185e1e68f34e?auto=format&fit=crop&w=1200&q=88",genre:"FPS",dev:"Riot Games",players:"4.6k",rating:"4.9",totalPlayers:"20M",officialUrl:"https://playvalorant.com",online:true,description:"Precision tactical FPS action with agent abilities and round strategy."},
{id:"roblox",name:"Roblox",short:"RBX",logo:LOGO_BASE+"Roblox_Logo_2022.svg",cover:"https://images.unsplash.com/photo-1511512578047-dfb367046420?auto=format&fit=crop&w=1200&q=88",genre:"Sandbox",dev:"Roblox",players:"6.9k",rating:"4.8",totalPlayers:"200M",officialUrl:"https://www.roblox.com",online:false,description:"A huge player-made universe of experiences, creators, and communities."},
{id:"warzone",name:"Call of Duty: Warzone",short:"WZ",logo:LOGO_BASE+"Call_of_Duty_Warzone_Logo.png",cover:LOGO_BASE+"Call_of_Duty_Warzone.jpg",genre:"Battle Royale",dev:"Activision",players:"7.2k",rating:"4.8",totalPlayers:"50M",officialUrl:"https://www.callofduty.com/warzone",online:true,description:"Large-scale online combat with squad play, movement, and seasonal content."},
{id:"genshin",name:"Genshin Impact",short:"GI",logo:LOGO_BASE+"Genshin_Impact_wordmark.svg",cover:"https://images.unsplash.com/photo-1513542789411-b6a5d3e3166e?auto=format&fit=crop&w=1200&q=88",genre:"Action",dev:"HoYoverse",players:"3.8k",rating:"4.8",totalPlayers:"60M",officialUrl:"https://genshin.hoyoverse.com",online:true,description:"Open-world action RPG exploration with elemental combat and a large world."},
{id:"lol",name:"League of Legends",short:"LOL",logo:LOGO_BASE+"League_of_Legends.png",cover:"https://images.unsplash.com/photo-1603481546238-487240415921?auto=format&fit=crop&w=1200&q=88",genre:"MOBA",dev:"Riot Games",players:"9.4k",rating:"4.9",totalPlayers:"100M",officialUrl:"https://www.leagueoflegends.com",online:true,description:"Classic 5v5 MOBA strategy with champions, objectives, and ranked competition."}
];

const state={genre:"All",query:"",favorites:new Set(),featuredId:"mlbb"};
const els={
...
function cardMarkup(g,i){
  return '<article class="game-card spotlight-card" data-game-id="'+esc(g.id)+'" style="--stagger:'+(i*.06)+'s">'+
    ...
    '<p class="game-desc">'+esc(g.description)+'</p><div class="game-stats"><span class="game-stat game-online">'+(g.online?'<span class="mini-online-dot"></span>':'<span class="offline-dot"></span>')+' <strong>'+esc(g.players)+'</strong> online</span><span class="game-stat">⭐ <strong>'+esc(g.rating)+'</strong></span><span class="game-stat">🎮 <strong>'+esc(g.totalPlayers)+'</strong></span></div>'+
...
const statusTick=()=>{games.forEach(g=>{if(Math.random()<.45)g.online=!g.online});renderFeatured();renderGames()};
setInterval(statusTick,10000);