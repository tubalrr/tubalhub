...
const el = {
  tabs:$$(.selector = ".settings-tabs [data-tab]"),
  panels:$$(.selector = ".settings-panel[data-panel]"),
  toast:$("#settingsToast"),
  ...
  themeCards:$$(.selector = "[data-theme-choice]"),
...
async function confirmDelete() {
  ...
  try {
    ...
    try { localStorage.clear(); sessionStorage.clear(); } catch {}
    storageSet(KEYS.deleteMarker,new Date().toISOString());
    window.location.href="login.html";
  } catch(error) {
